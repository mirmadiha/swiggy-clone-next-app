export default function SidePanel({ isOpen, onClose, children, widthClass = "w-2/5", position = "left" }) {
  ...
  return (
    ...
    >
      <div
        className={`${widthClass} h-full bg-white shadow-lg pl-30 pr-[40px] absolute ${sideClass} transform transition-transform duration-500 ease-in-out ${translateClass}`}
